...
def process_all_videos(root_folder, output_folder, model):
    ...
    for video_folder in tqdm(video_folders,desc=f'Features From "{root_folder}"'):
...
if '__main__' == __name__:
    ...
    for dir in ['train/','test/','val/']:
        input_dir = data_dir + dir + "frames/"
        output_dir = data_dir + dir + 'pFeatures'
        os.makedirs(output_dir, exist_ok=True)
        process_all_videos(input_dir, output_dir, holistic)
